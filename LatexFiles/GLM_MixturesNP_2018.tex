...
For the zero-inflated Poisson model (ZIP model see \citep{Lambert}) we can split the conditional density $f(y|\bm{x},\bm{\vartheta_j})$ into zero and non-zero densities. %Nik: I don't think "groups" is what is meant.  % Values I meant. 
