...
Here, $\mathcal{\omega}_i$ is the number of claims the client occurs over the exposure period. Since $\mathcal{\omega}_i$ is constant at every EM iteration s, the flexCWM package is easily adjusted to account for this additional weight by multiplying  $\pi^{(s)}_{ij}$. 
