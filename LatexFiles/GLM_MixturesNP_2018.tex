...
\begin{table}[!htbp] \centering
  \caption{Comparison of AIC and BIC for CWM versus GCWM for $k$ number of clusters estimated. \textcolor{red}{[Column~2 here is ``k''. What is ``k''?]}}\label{comparingCWM_models}
...
\begin{figure}[!htb]
\begin{center}
\includegraphics[scale=0.50]{lossDensity_v1}
\end{center}
\vspace{-0.2in}
