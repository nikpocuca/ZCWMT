...
g(\mathbb{E}\left[Y_{LossAmount}|\bm{x}\right]) = 
 & \beta_{j0} +  \beta_{jDensity}\bm{x}_{Density}+ \beta_{jCar Age} \bm{x}_{Car Age}+ \beta_{jDriver Age} \bm{x}_{Driver Age} + \nonumber \\ &  \beta_{jRegion}\bm{x}_{Region} + \beta_{jPower}\bm{x}_{Power} + \beta_{jGas} \bm{x}_{Gas}. \label{regressionModel}
\end{align}
...
g_p(\mathbb{E}\left[Y_{ClaimNb}|\bm{X}\right]) & = 
  \beta_{0} +  \beta_{Density}\bm{x}_{Density}+ \beta_{Exposure} \bm{x}_{Exposure}+ \beta_{Power}\bm{x}_{Power}, \label{poissonReg} \\
g_z(\mathbb{E}\left[Y_{ClaimNb}|\bm{X}\right])& = \bar{\beta}_0 + \bar{\beta}_{Exposure} \bm{x}_{Exposure} +  \bar{\beta}_{CarAge} \bm{x}_{CarAge}, \label{zeroReg}
\end{align}
